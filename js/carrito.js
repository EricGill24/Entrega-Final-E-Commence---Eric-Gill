...
function cargarProductosCarrito(){
    if (productosEnCarrito && productosEnCarrito.length > 0){
        ...
        contenedorCarritoProductos.classList.remove("disabled");contenedorCarritoAcciones.classList.remove("disabled");
    ...
    `;
        ...
        contenedorCarritoProductos.classList.add("disabled");contenedorCarritoAcciones.classList.add("disabled");
        contenedorCarritoComprado.classList.add("disabled");
    }
...
function vaciarCarrito(){
    ...
    Swal.fire({
        ...
        Swal.fire(
            'Carrito vacío!',
            'Todos los poductos han sido eliminados',
            'success'
            )
